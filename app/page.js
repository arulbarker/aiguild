...
const PAY_URL = process.env.NEXT_PUBLIC_MAYAR_PAYMENT_URL || '#'
          ...
          <div className="rounded-3xl p-8 sm:p-12 text-center" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
            ...
            <div style={{ maxWidth: 380, margin: '0 auto' }}>
              ...
              <p className="mt-6" style={{ fontSize: 13, color: 'var(--muted)' }}>
                Belum punya akses?{' '}
                <a href={PAY_URL} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--amber)' }} className="hover:underline">Gabung di sini</a>
              </p>
            </div>
          </div>
        </Reveal>
